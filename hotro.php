<form class="form-group" action="insert_hotro.php" method="post" name="frm" onsubmit="return kiemtra()">
    <div id="hotro">
        <h3>HỖ TRỢ</h3>
        <table>
            <tr>
                <td>Chủ đề <font color="red">*</font> :</td>
                <td><input class="form-control" type="text" name="chude" size="40"></td>
            </tr>
            <tr>
                <td>Họ tên <font color="red">*</font> :</td>
                <td><input class="form-control" type="text" name="hoten" size="40"></td>
            </tr>
            <tr>
                <td>Email <font color="red">*</font> :</td>
                <td><input class="form-control" type="text" name="email" size="40"></td>
            </tr>
            <tr>
                <td>Điện thoại <font color="red">*</font> :</td>
                <td><input class="form-control" type="text" name="dienthoai" size="40"></td>
            </tr>
            <tr>
                <td>Nội dung <font color="red">*</font> :</td>
                <td><textarea class="form-control" name="noidung"></textarea></td>
            </tr>
            <tr>
                <td colspan=2 class="btnhotro">
                    <input class="btn btn-primary" type="submit" name="submit" value="GỬI">
                    <input class="btn btn-secondary"  type="reset" value="HỦY">
                </td>
            </tr>
        </table>
    </div>
