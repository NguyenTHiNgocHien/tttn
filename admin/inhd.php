                              ...
                              <tbody>
                                <tr>
                                  <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        <tr>
                                          <td colspan="2"><strong>QBeauty  </strong></td>
                                        </tr>
                                        <tr>
                                          <td>Địa chỉ</td>
                                          <td>:Kiến An - Thành Phố Hải Phòng</td>
                                        </tr>
                                        <tr>
                                          <td width="65">Tel:</td>
                                          <td>: 1800 300402</td>
                            ...
                            <tr>
                              ...
                              <td ><span class="style3">Phương thức thanh toán:</span></td>
							   <?php		
								...
								?>
                              <td ><?php if($row2['phuongthucthanhtoan']==1) echo "Chuyển khoản"; else if($row2['phuongthucthanhtoan']==2) echo "Thanh toán trực tiếp"; ?></td>
                            </tr>
                    </table>
        <br />
