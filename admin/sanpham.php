...
<a href='?admin=themsp'>Thêm sản phẩm</a><br>
	...
	<p>Có tổng <font color=red><b><?php echo $dem ?></b></font> SP</p>
...
?>
	...
	<?php
			...
			$total_results = mysqli_query($link,"SELECT COUNT(*) as Num FROM sanpham");  

			// Tính tổng số trang. Làm tròn lên sử dụng ceil()  
			$total_pages = ceil($max_results);  
